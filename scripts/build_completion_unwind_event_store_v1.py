#!/usr/bin/env python3
"""Build completion/unwind event store for inventory-cycle research.
...
DEFAULT_STORE_NAME = "completion_unwind_event_store_v1"
...
def main() -> int:
    ...
    with lock_path.open("w", encoding="utf-8") as lock_file:
        ...
        try:
            ...
            manifest = {
                "schema_version": "completion_unwind_event_store_v1",
            ...
            (tmp_dir / "README.md").write_text(
                "\n".join(
                    [
                        "# Completion/Unwind Event Store V1",
                        "",
                        ...
                        "- `l1_price_change` rows represent visible top-of-book price-change opportunities.",
